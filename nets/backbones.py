...
def keras_backbone(backbone, inputs, input_shape, weights):
    """
    ...
    if backbone == 'resnet50':
        ...
        x = keras.applications.resnet.ResNet101(
            include_top=False,
            weights=weights,  # weights='imagenet'
            input_tensor=inputs,
            input_shape=input_shape,
        ...
        x = keras.applications.resnet.ResNet152(
            include_top=False,
            weights=weights,  # weights='imagenet'
            input_tensor=inputs,
            input_shape=input_shape,
        ...
        x = keras.applications.nasnet.NASNetLarge(
            include_top=False,
            weights=weights,  # weights='imagenet'
            input_tensor=inputs,
            input_shape=input_shape,
        ...
        x = keras.applications.efficientnet_v2.EfficientNetV2M(
            include_top=False,
            weights=weights,  # weights='imagenet'
            input_tensor=inputs,
            input_shape=input_shape,
